    ...
    <footer className="md:flex md:justify-around bg-blue-400">
      <div class="font-inter flex flex-col p-6 gap-4 md:justify-center">
        ...
        <div class="flex gap-4 items-center self-center md:self-start">
          <a href="https://www.linkedin.com/in/ianluong/" target="_blank" className="hover:text-white focus:text-white" rel="noreferrer">
              <FontAwesomeIcon icon={faLinkedin} size="3x" />
          </a>
          <a href="https://www.instagram.com/ian__luong/" target="_blank" className="hover:text-white focus:text-white" rel="noreferrer">
            <FontAwesomeIcon icon={faInstagram} size="3x" />
          </a>
          <a href="https://github.com/IanLuong" target="_blank" className="hover:text-white focus:text-white" rel="noreferrer">
            <FontAwesomeIcon icon={faGithub} size="3x" />
          </a>
          <a href="mailto:ianluongcodes@gmail.com" target="_blank" className="hover:text-white focus:text-white" rel="noreferrer">
            <FontAwesomeIcon icon={faEnvelope} size="3x" />
          </a>
        </div>
      </div>
      <img className="md:w-1/2 md:p-8" src={footerPortrait} alt="Cute sleeping cat" />
    </footer>
  );
}
