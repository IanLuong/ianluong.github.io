  ...
  return (
    <header className="max-w-5xl m-auto absolute sm:relative sm:block w-screen p-4 z-10">
      <div className="flex justify-between items-center max-w-5xl m-auto">
        <span className="font-semibold text-3xl px-4 py-2 rounded-xl border-2 border-almostBlack bg-almostWhite">
          ian.
        </span>
          ...
          <ul className="flex gap-4 text-lg font-medium text-almostBlack">
            ...
            <li>
              <a
                href="/IanLuongCV.pdf"
                target="_blank"
                className="text-center border-2 border-almostBlack rounded-xl px-4 py-2 transition-all duration-300 cursor-pointer hover:bg-peach hover:text-3xl focus:bg-peach focus:text-3xl"
              >
                CV
              </a>
            </li>
