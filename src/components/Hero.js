    ...
    return (
      <section className="bg-red-400">
        ...
        <div className="bg-white">
          <div
            className="md:m-auto md:w-2/3 lg:w-1/2"
            ref={scrollRef}
          >
            <div className="flex flex-col p-6 gap-4 font-inter">
              ...
              <p>
                Rerum molestias et nulla soluta iste a autem deserunt. Libero
                non non et rerum sunt ea non. Repudiandae possimus ipsa sequi.
                Aut praesentium facilis quidem quo qui quasi non dolores vel.
                Beatae voluptates et reprehenderit dolores dolore.
              </p>
              <p>
              ...
              <p>
                ...
                facere. Eius debitis voluptas aut velit consequatur ratione
                rerum sed. Ab alias doloremque rerum. Minus nihil commodi
                voluptatem amet blanditiis aut laboriosam eum et. Consequatur
                possimus omnis libero est quia dolor.
              </p>
            </div>
          </div>
        </div>
