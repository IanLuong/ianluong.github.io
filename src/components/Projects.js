      ...
      <div className="flex flex-col items-center px-6 py-8 gap-4">
        ...
        <div className="flex flex-col gap-12 max-w-screen-lg">
          <Project
            ...
            desc={["Record store website produced to replicate an online shopping experience. Features include a shopping cart, info pages for the records and more!", "\n\n", "(Feel free to take a peek at my music taste and maybe some records that I own)"]}
            imgPath={spoofy}
          ...
          <Project
            title="Anime Quiz"
            desc={["Mini quiz app made to entertain a growing, local anime community. Quiz questions are pulled from the Open Trivia DB API and contain both multiple choice and true or false questions.", "\n\n", "Features copy to clipboard score sharing so you can let the group chat lads know, you are the one and only GOAT."]}
            imgPath={quiz}
          ...
          <Project
            title="Kamatimer"
            desc={["A Pomodoro Timer Web App created for friends and family to keep focused. The (completely optional) use-sound hook makes use of sound to announce breaks", "\n\n", "P.S Kamatis means Tomato in Tagalog."]}
            imgPath={kamatimer}
