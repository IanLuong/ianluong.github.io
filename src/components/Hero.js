      ...
      <div className="md:m-auto md:w-2/3" ref={scrollRef}>
        <div className="flex flex-col p-6 gap-4 font-inter">
          ...
          <p>
            ...
            laboriosam aut qui reiciendis voluptas maxime voluptatibus maxime
            sed.
          </p>
          <p>
            ...
            sed. Ab alias doloremque rerum. Minus nihil commodi voluptatem amet
            blanditiis aut laboriosam eum et. Consequatur possimus omnis libero
            est quia dolor.
          </p>
        </div>
      </div>
